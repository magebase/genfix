...
const Index: React.FC<EquipmentIndexProps> = ({ equipment }) => {
  useEffect(() => {
            ...
            <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="text-center mb-16">
                ...
                <p
                  ...
                  data-aos-delay="600"
                >
                  From small portable generators to heavy-duty industrial units,
                  we have the perfect power solution for your Brisbane business.
                </p>
                    ...
                    >
                      <div className="mb-4">
                        <img
                          src={
                            item.image_url ||
                            "/images/generator-maintenance.jpg"
                          }
                          alt={item.name}
