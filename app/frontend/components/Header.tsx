...
import { Zap, Phone, Sparkles, X } from "lucide-react";
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2 md:gap-4">
            <a
              ...
              className="hidden md:flex items-center gap-2 bg-green-600 hover:bg-green-700 text-white px-4 py-4 rounded-lg font-medium transition-colors duration-200 h-12"
            >
            ...
            <a
              href="/#quote-form"
              className="hidden sm:flex items-center gap-2 bg-white text-gray-900 px-4 py-4 rounded-lg font-medium transition-colors duration-200 hover:bg-gray-100 text-sm md:text-base h-12"
            >
        ...
        <div className="md:hidden bg-gray-900 text-white border-t border-gray-700">
          <div className="max-w-7xl mx-auto px-4 py-4">
            <nav className="flex flex-col space-y-4">
              ...
              <a
                href="/#quote"
                className="text-white hover:text-gray-300 font-medium py-2 transition-colors duration-200 flex items-center gap-2"
                onClick={() => setIsMobileMenuOpen(false)}
              >
                <Sparkles className="w-4 h-4" />
                Get Quote
